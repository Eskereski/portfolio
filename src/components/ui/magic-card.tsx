...
export function MagicCard(props: MagicCardProps) {
	const {
		...
		className,
		gradientSize = 200,
		gradientColor = "rgba(255, 255, 255, 0.28)",
	...
	return (
		<motion.div
			className={cn(
				...
				"border-zinc-200/80 bg-white dark:border-white/10 dark:bg-black",
				className
			)}
		...
		>
			...
			{mode === "orb" && (
				<motion.div
					suppressHydrationWarning
					aria-hidden="true"
					className="pointer-events-none absolute z-15 mix-blend-multiply dark:mix-blend-screen"
					style={{
						width: glowSize,
						height: glowSize,
						x: orbX,
