...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "group transition-transform duration-150 ease-out hover:-translate-y-0.5 hover:scale-[1.02]",
        "transition-colors duration-150 ease-out",
        className,
        isDark
          ? "hover:bg-white hover:text-zinc-900 hover:border-zinc-300"
              + " dark:hover:bg-white dark:hover:text-zinc-900 dark:hover:border-zinc-300"
          : "hover:bg-zinc-950 hover:text-zinc-50 hover:border-zinc-700"
      )}
      {...props}
    >
